...
ComponentV2::ComponentV2(
  ...
  // TODO(akbiggs): Close handles from ComponentStartInfo::numbered_handles
  ...
  // TODO(akbiggs): There's an OnPublishDiagnostics event we may want to
...
void ComponentV2::Stop() {
  ...
  // TODO(akbiggs): Any other cleanup logic we should do that's appropriate
